...
begin
  ...
  Pictures.LoadFromFile('игра\картинка.BMP');
  ...
  if count = 1 then begin
    ...
    if (open1.col = open2.col) and (open1.row = open2.row)
      ...
      if Pole[open1.col,open1.row] = Pole[open2.col,open2.row] then
        ...
        begin
          n := n+1;
          GAME.Timer1.Enabled := True; // запустить таймер
...
begin
  ...
  begin
    ...
    GAME.Canvas.Font.Color := clBlack;
    GAME.Canvas.TextOut(70,140,'Поздравляю!');
  end;
end;
...
Canvas.Rectangle(0,0,ClientWidth,ClientHeight);
    NewGame;
    Pictures.LoadFromFile('игра\картинка1.BMP');
end;
...
Canvas.Rectangle(0,0,ClientWidth,ClientHeight);
    NewGame1;
     Pictures.LoadFromFile('игра\картинка2.BMP');
end;
