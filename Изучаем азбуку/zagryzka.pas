...
begin
  ...
  else if sGauge1.Progress = 100 then // Условие для перехода
  begin
    Timer1.Enabled := False; // Остановка таймера после достижения 100%
    zag.Show; // Показать вторую форму
    nachalo.Close; // Закрыть текущую форму
  end;
end;
